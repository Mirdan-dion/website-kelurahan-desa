...
<html lang="en">
  <head>
    ...
    <title>Herman Abdara S.Pd</title>
    <!-- fonts -->
  ...
  <body>
    <!-- navbar start -->
    <nav class="navbar">
      <a href="index-admin.php" class="navbar-logo">Herman<span>Abdara</span>.</a>
...
<section id="menu" class="menu">
    ...
    <p>Berikut adalah berita-berita seputar desa talapiti:</p>
