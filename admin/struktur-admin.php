...
<nav class="navbar">
    ...
    <div class="organization-chart">
        ...
        <div class="level">
            <div class="position">
                <img class="photo" src="../img/fkd.jpg" alt="Kadus Nggaro Nangga">
            ...
            <div class="position">
                <img class="photo" src="../img/fkd.jpg" alt="Kadus Tolowata">
                <h3>Kadus Tolowata</h3>
                <p>Amrun</p>
                <p>--</p>
            </div>
            <div class="position">
                <img class="photo" src="../img/fkd.jpg" alt="Kadus Tala Na'e">
                <h3>Kadus Tala Na'e</h3>
                <p>Maman Husen</p>
                <p>--</p>
            </div>
            <div class="position">
                <img class="photo" src="../img/fkd.jpg" alt="Kadus Tala Rasabou">
                <h3>Kadus Tala Rasabou</h3>
                <p>Israudin, S.Pd</p>
                <p>--</p>
            </div>
            <div class="position">
                <img class="photo" src="../img/fkd.jpg" alt="Kadus Tala Boka">
                <h3>Kadus Tala Boka</h3>
                <p>Mahmud Bakar</p>
                <p>--</p>
            </div>
        </div>
